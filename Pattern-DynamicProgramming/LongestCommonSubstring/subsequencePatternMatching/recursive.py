...
def recursive(str,pat,strIdx, patIdx):
    ...
    if str[strIdx] == pat[patIdx]:
        c1 = recursive(str,pat,strIdx+1,patIdx+1)
    
    c2 = recursive(str,pat,strIdx+1,patIdx)

    return c2 + c1

# Time complexity is O(2^M) where M is the length of the string
