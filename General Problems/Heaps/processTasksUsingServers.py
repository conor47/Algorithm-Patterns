...
# Time complexity is O(N Log M) where N is number of tasks and M is the number of servers

# Space complexity is O(M) for the two heaps which contain at most M items